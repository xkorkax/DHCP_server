#!/usr/bin/env python3
"""Test script for DHCP server - simulates full DORA cycle and RELEASE."""
...
def build_request(requested_ip, server_id):
    packet = build_base_packet()
    offset = 240
...
# 1. Send DISCOVER
send_packet(sock, build_discover(), "DHCP DISCOVER")
...
try:
    ...
    if offered_ip and server_id:
        ...
        send_packet(sock, build_request(offered_ip, server_id), "DHCP REQUEST")
