...
Projekt to implementacja serwera protokołu DHCP w języku C. Serwer w pełni obsługuje standardowy proces przypisywania adresów IP (cykl DORA), poprawne zwalnianie zasobów (Release) oraz wysyłanie odmowy (NAK) w przypadku nieautoryzowanych lub błędnych żądań o adres IP z puli.
